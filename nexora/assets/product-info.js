    ...
    class ProductInfo extends HTMLElement {
      ...
      handleUpdateProductInfo(productUrl) {
        return (html) => {
          ...
          updateSourceFromDestination('Weight', ({ innerText }) => innerText.trim() === '');
          updateSourceFromDestination('Specs', ({ innerText }) => innerText.trim() === '');
      ...
      setUnavailable() {
        ...
        const selectors = ['price', 'Inventory', 'Sku', 'Weight', 'Specs', 'Price-Per-Item', 'Volume-Note', 'Volume', 'Quantity-Rules']
